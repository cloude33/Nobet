...
enum class ShiftType(val label: String, val hours: Int, val color: androidx.compose.ui.graphics.Color) {
    ...
    ANNUAL_LEAVE("Yİ", 0, androidx.compose.ui.graphics.Color(0xFF4CAF50)), // Yeşil - Yıllık İzin
    REPORT("RP", 0, androidx.compose.ui.graphics.Color(0xFFFF9800))       // Turuncu - Rapor
}